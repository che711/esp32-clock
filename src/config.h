...
//   выключено, и команду «верни автоматику» отправить уже некуда. Поэтому из
//   него есть два выхода. Первый и главный — заряд: банка выше порога с
//   запасом выпускает из выживания, кем бы оно ни было включено
//   (powerManualMode в power_calc.h). Раньше его не было, и зафиксированное
//   руками выживание не отпускало даже полную банку.
//   Второй, этот, — подстраховка на случай, когда банка так и не подросла:
//   через час решение возвращается автоматике. Обычный и эконом фиксируются
//   бессрочно — свой уровень они не рвут; но и они не отменяют вето по заряду,
//   иначе зафиксированный обычный режим жёг бы радио до brownout.
